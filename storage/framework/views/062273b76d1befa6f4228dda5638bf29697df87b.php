...
<form action="<?php echo e(route('signup')); ?>" method="post">
    <div class="">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="first_name" id="first_name" placeholder="Nombre" value="<?php echo e(Request::old('first_name')); ?>">
        </div>
        <div class="form-group">
            <label class="control-label" for="">Apellido</label>
            <input type="text" class="form-control" name="last_name" id="last_name" placeholder="Apellido"  value="<?php echo e(Request::old('last_name')); ?>">
        </div>
        <div class="form-group">
            <label class="control-label" for="">Email</label>
            <input type="email" class="form-control" name="email" placeholder="Email"  value="<?php echo e(Request::old('email')); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" name="password_confirmation" placeholder="Repeat Password" value="<?php echo e(Request::old('password_confirmation')); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <a class="btn btn-block btn-social btn-facebook" href="<?php echo e(route('social_redirect', ['provider' => 'facebook'])); ?>" style="text-align:center">
                <span class="fa fa-facebook"></span> Iniciar con Facebook
            </a>
            <a class="btn btn-block btn-social btn-google" href="<?php echo e(route('social_redirect', ['provider' => 'google'])); ?>" style="text-align:center">
