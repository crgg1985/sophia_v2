...
<script>
    ...
    function deleteFile(id) {
        $.ajax({
            ...
            data: { _method: 'delete', _token :"<?php echo e(Session::token()); ?>", idFile: id }
        })
    ...
    function toggleLikeFile(id) {
        $.ajax({
            ...
            data: { _token :"<?php echo e(Session::token()); ?>", idFile: id }
        })
        .done(function( response ) {
    ...
    function genPrivateTable() {
        ...
        $('#private-files-table').DataTable({
            ...
            ajax: {
                url: '<?php echo route('files.privateDataTable', ['idRamo' => $ramo->id]); ?>',
                method: 'POST'
            },
            columns: [
                { data: 'name', name: 'name' },
    ...
    function genPublicTable() {
        ...
        $('#public-files-table').DataTable({
            ...
            ajax: {
                url: '<?php echo route('files.publicDataTable', ['idRamo' => $ramo->id]); ?>',
                method: 'POST'
            },
            columns: [
