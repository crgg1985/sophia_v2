...
<form action="<?php echo e(route('tomaCarrera')); ?>" method="post" name="tomaCarrera" id="tomaCarrera">
    ...
    <label >Selecciona tipo de Institución</label>
        <div>
            <Select class="form-control input-sm" name="tipo_institucion" id="tipo_institucion">
                ...
                <?php $__currentLoopData = $tipos_institucion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo_inst): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <option value=" <?php echo e(@$tipo_inst->id); ?>"><?php echo e(@$tipo_inst->descripcion); ?></option>
