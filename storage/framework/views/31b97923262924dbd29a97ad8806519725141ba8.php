...
<div class="col-sm-8">
	<div class="panel" style="padding-left:15px; padding-right:15px; text-align:center ">
		...
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" name="nombre" placeholder="nombre" value="<?php echo e($docenteEditar->nombre); ?>">
		</div>
		<div class="form-group">
			<label class="control-label" for="">Apellido Paterno</label>
			<input type="text" class="form-control" name="apellido_paterno" placeholder="apellido_paterno" value="<?php echo e($docenteEditar->apellido_paterno); ?>">
		</div>
		<div class="form-group">
			<label class="control-label" for="">Apellido Materno</label>
			<input type="text" class="form-control" name="apellido_materno" placeholder="apellido_materno" value="<?php echo e($docenteEditar->apellido_materno); ?>">
		</div>
		<div class="form-group">
			<label class="control-label" for="">Email</label>
			<input type="text" class="form-control" name="email" placeholder="email" value="<?php echo e($docenteEditar->email); ?>">
		</div>
		<div class="form-group">
