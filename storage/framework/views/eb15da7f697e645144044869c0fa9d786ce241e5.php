		...
		<h3><i class="fa fa-shield"></i> Creación de Usuarios</h3>
	  	...
	  	<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">    
			<div class="form-group">
			  ...
			  <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" value="<?php echo e(Request::old('nombre')); ?>" required >
			</div>
			<div class="form-group">
			  <label class="control-label" for="">Apellido</label>
			  <input type="text" class="form-control" name="apellido" id="apellido" placeholder="Apellido" value="<?php echo e(Request::old('apellido')); ?>"required >
			</div>
			<div class="form-group">
