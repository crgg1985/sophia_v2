      ...
      <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="fb-user-thumb">
                <?php if(Storage::disk('local')->has( $posteoCarrera->nombre . '-' . $posteoCarrera->id_user. '.jpg')): ?>
                    <img src="<?php echo e(route('profile.image', ['filename' => $posteoCarrera->nombre . '-' . $posteoCarrera->id_user. '.jpg'])); ?>" alt="" class="img-circle">
                <?php else: ?>
                    <img src="<?php echo e(URL::to('img/man_avatar.jpg')); ?>" alt="" class="img-circle">
                <?php endif; ?>
            </div>
            <div class="fb-user-details">
                <h3><a href="#" class="#"> <?php echo e($posteoCarrera->nombre); ?></a></h3>
            ...
            <div class="fb-status-container fb-border">
                <div class="fb-time-action">
                    <article class="post">
                        ...
                        <?php if($posteoCarrera->id_user == $usuario->id): ?>
                            <span>-</span>
