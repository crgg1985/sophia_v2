        ...
        <div class="col-sm-10">
            <div class="panel panel-default">
                <div class="panel-body" style="padding-left:50px;  padding-top:25px; padding-right:50px; padding-bottom:30px" >
                    ...
                    <?php echo Form::open(['route' => 'messages.store', 'id' => 'new-message']); ?>

                        <div style="display:none;">
                            <input type="text" id="uuid" name="uuid" value="<?php echo e(Request::segment(2)); ?>" readonly class="form-control">
                        </div>
                        ...
                        <br>
                        <?php echo e(Form::submit('Nuevo mensaje', ['class' => 'btn btn-success', 'style' => 'width: 100%'])); ?>
...
<script>
    ...
    const endPointGetMessages = siteUrl + "messages/<?php echo e(Request::segment(2)); ?>/chat";
    ...
    function createElement(value) {
        ...
        if(value.read == 0 || value.read == "0") {
            $.get( "<?php echo e(route('messages.markAsRead', ['id' => Request::segment(2)])); ?>", function( data ) {
